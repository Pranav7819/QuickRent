...
const ListingDetails = () => {
  ...
  // Calculate dayCount whenever dateRange changes
  ...
  const handleSubmit = async () => {
    if (!customerId || !listing) {
      console.error("Missing customer ID or listing details");
      return;
    }
  ...
  if (!listing) {
    return <p>Listing details not found.</p>;
  }
